...
class GantryFeaturelogo extends GantryFeature {
    ...
    function render($position) {
        ...
        ob_start();
        $type = 'gantry';
        if(isset($gantry->document) && isset($gantry->document->params) && is_object($gantry->document->params) && isset($gantry->document->params->get('logo')->type)){
            $type = $gantry->document->params->get('logo')->type;
        }
        ?>
        <div class="rt-block logo-block">
            <a href="<?php echo $gantry->baseUrl; ?>" id="rt-logo"><?php if($type === 'custom'): ?><img id="rt-logo-img" alt="" src="<?php echo $gantry->baseUrl; ?>templates/<?php echo $gantry->getCurrentTemplate(); ?>/images/transparent.png" alt=""/><?php else: ?><img id="rt-logo-img" alt="" src="<?php echo $gantry->baseUrl; ?>templates/<?php echo $gantry->getCurrentTemplate(); ?>/images/logo/logo-large.png" alt=""/><?php endif;?></a>
        </div>
        <?php
        return ob_get_clean();
    }
